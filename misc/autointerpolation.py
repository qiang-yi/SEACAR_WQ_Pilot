...
def interpolation_auto(method,gis_path,dataframe,managed_area,Year,Season,start_date,end_date,parameter,covariates,out_raster,out_ga_layer,predict_std_err):
    ...
    input_pt = gis_path+"input_point/{}/{}_{}{}_{}.shp".format(*out_raster)
    print(out_raster)
    ...
    try:
        ...
        out_raster   = gis_path +"output_raster/{}/{}_{}{}_{}.tif".format(*out_raster)
        value_field  = "ResultValu"
        out_ga_layer = gis_path + "ga_layer/{}/{}_{}{}_{}.lyrx".format(*out_ga_layer)
        ga_to_raster = gis_path + 'standard_error_prediction/{}/{}_{}{}_{}_sep.tif'.format(*predict_std_err)
        in_explanatory_rasters = in_explanatory_rasters
